      ...
      <div>
        <div className="flex flex-col md:flex-row justify-center text-justify mb-6">
            <div>
                ...
                <p className="lg:w-96 mr-8 text-gray-400">Welcome to XYZ Jewelry, where every piece of jewelry is handcrafted with love and care to bring out the inner radiance in you. As a family-owned business with a passion for exquisite jewelry, we take pride in our unique designs and exceptional craftsmanship. </p>
            </div>
            <img src={about} alt="" />
        </div>
        <div>
