...
const CategoriesName = () => {
    return (
        <div>
        <h4 className="text-xl text-center lg:text-left md:hidden lg:block">Categories</h4>
        <div className="bg-white w-56 mx-auto shadow-md shadow-gray-300 border border-gray-300 rounded-md mt-2 lg:mr-8 lg:p-2 md:hidden lg:block">
        ...
        <h4 className="text-xl mt-10 text-center lg:text-left md:hidden lg:block">Brands</h4>
        <div className="bg-white w-56 mx-auto shadow-md shadow-gray-300 border border-gray-300 rounded-md mt-2 lg:mr-8 lg:p-2 md:hidden lg:block">
            <div className="flex items-center text-gray-400 border-b border-dotted border-yellow-300 my-4 relative">
                <IoIosArrowRoundForward className="absolute left-0"></IoIosArrowRoundForward>
        ...
        <img src={LeftBanner} className="mt-10 mx-auto lg:mx-0 mb-8 md:hidden lg:block" alt="" />
      </div>
    );
};
